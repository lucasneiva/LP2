...
namespace PContato0030482221012
{
    public partial class frmCidade : Form
    {
        ...
        {
            if (txtNomeCidade.Text == "" || txtNomeCidade.Text.Length < 3 || txtNomeCidade.Text.Length > 50)
            {
                MessageBox.Show("Nome cidade inválido!");
            }
            else
            {
                Cidade RegCid = new Cidade();
                RegCid.Idcidade = Convert.ToInt32(txtID.Text);
                RegCid.Nomecidade = txtNomeCidade.Text.Trim();
